...
- **Storage architecture** — Dell PowerStore 500T, Dell PowerVault ME, Lenovo DE Series, synchronous block replication, HBA/iSCSI, NMP path policy
- **Backup & DR** — Veeam Backup & Replication (backup jobs, CDP at RPO=0), PowerStore synchronous replication, tested failover & rollback procedures
